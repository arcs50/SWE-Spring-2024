    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userAccount.food')),
            ],
        ),
        migrations.CreateModel(
            name='GroceryList',
            fields=[
                ...
                ('ingredients', models.ManyToManyField(to='userAccount.ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentInfo',
            fields=[
                ...
                ('billing_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userAccount.address')),
                ('subscriber', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userAccount.recipe')),
            ],
        ),
        migrations.AddField(
            model_name='ingredient',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userAccount.recipe'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('text', models.TextField()),
                ('posted_time', models.DateField(default=django.utils.timezone.now)),
                ('comment_parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userAccount.comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipes', models.ManyToManyField(to='userAccount.recipe')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subscriber', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('recipe', models.ManyToManyField(to='userAccount.recipe')),
            ],
        ),
        migrations.CreateModel(
            name='SocialMedia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chef', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('site_subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userAccount.sitesubscription')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chef_subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userAccount.chefsubscription')),
                ('subscriber', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
