...
# Generated by Django 4.2.11 on 2024-04-28 04:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement', models.CharField(choices=[('gal', 'gallon'), ('qt', 'quart'), ('g', 'gram'), ('tbsp', 'tablespoon'), ('slice', 'slice'), ('kg', 'kilogram'), ('pt', 'pint'), ('ml', 'milliliter'), ('cup', 'cup'), ('lb', 'pound'), ('oz', 'ounce'), ('fl oz', 'fluid ounce'), ('na', 'none'), ('L', 'liter'), ('tsp', 'teaspoon'), ('slices', 'slices')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform', models.CharField(choices=[('TW', 'Twitter'), ('TK', 'TikTok'), ('Y', 'YouTube'), ('F', 'Facebook'), ('S', 'Snapchat'), ('I', 'Instagram')], max_length=2)),
