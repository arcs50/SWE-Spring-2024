    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement', models.CharField(choices=[('na', 'none'), ('gal', 'gallon'), ('pt', 'pint'), ('cup', 'cup'), ('oz', 'ounce'), ('ml', 'milliliter'), ('tbsp', 'tablespoon'), ('L', 'liter'), ('qt', 'quart'), ('lb', 'pound'), ('fl oz', 'fluid ounce'), ('g', 'gram'), ('slices', 'slices'), ('kg', 'kilogram'), ('slice', 'slice'), ('tsp', 'teaspoon')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform', models.CharField(choices=[('Y', 'YouTube'), ('I', 'Instagram'), ('TW', 'Twitter'), ('F', 'Facebook'), ('S', 'Snapchat'), ('TK', 'TikTok')], max_length=2)),
