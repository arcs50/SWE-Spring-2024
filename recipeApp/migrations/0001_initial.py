    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement', models.CharField(choices=[('L', 'liter'), ('na', 'none'), ('qt', 'quart'), ('slice', 'slice'), ('lb', 'pound'), ('slices', 'slices'), ('fl oz', 'fluid ounce'), ('g', 'gram'), ('kg', 'kilogram'), ('tbsp', 'tablespoon'), ('cup', 'cup'), ('gal', 'gallon'), ('pt', 'pint'), ('ml', 'milliliter'), ('tsp', 'teaspoon'), ('oz', 'ounce')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform', models.CharField(choices=[('F', 'Facebook'), ('S', 'Snapchat'), ('Y', 'YouTube'), ('TK', 'TikTok'), ('TW', 'Twitter'), ('I', 'Instagram')], max_length=2)),
