    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement', models.CharField(choices=[('tbsp', 'tablespoon'), ('qt', 'quart'), ('fl oz', 'fluid ounce'), ('lb', 'pound'), ('gal', 'gallon'), ('kg', 'kilogram'), ('tsp', 'teaspoon'), ('na', 'none'), ('slices', 'slices'), ('oz', 'ounce'), ('g', 'gram'), ('ml', 'milliliter'), ('L', 'liter'), ('pt', 'pint'), ('cup', 'cup'), ('slice', 'slice')], max_length=15)),
